...
exports.getTransporter = exports.sendLoginVerificationEmail = exports.sendAssignmentNotification = exports.sendAbsenceNotification = exports.sendMeetingNotification = exports.sendWelcomeEmail = exports.sendPasswordResetEmail = void 0;
...
const sendPasswordResetEmail = async (email, resetLink) => {
    return sendEmail(email, `[${APP_NAME}] Réinitialisation de mot de passe`, `
...
const sendWelcomeEmail = async (email, firstName, role) => {
    ...
    return sendEmail(email, `[${APP_NAME}] Bienvenue !`, `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
const sendMeetingNotification = async (email, firstName, meetingDate, teacherName) => {
    return sendEmail(email, `[${APP_NAME}] Réunion confirmée`, `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
const sendAbsenceNotification = async (email, parentName, studentName, date) => {
    return sendEmail(email, `[${APP_NAME}] Absence de ${studentName}`, `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
const sendAssignmentNotification = async (email, studentName, assignmentTitle, dueDate, teacherName) => {
    return sendEmail(email, `[${APP_NAME}] Nouveau devoir : ${assignmentTitle}`, `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
const sendLoginVerificationEmail = async (email, code) => {
    return sendEmail(email, `[${APP_NAME}] Code de vérification`, `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
...
exports.sendLoginVerificationEmail = sendLoginVerificationEmail;
// Export du transporteur pour utilisation avancée
const getTransporter = () => initTransporter();
